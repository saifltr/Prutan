...
prompt = ChatPromptTemplate.from_messages([
    ...
    Also make sure to include the output from the tools that you used
    When generating the final output make sure you refer to the tool and what it returns your task is to return the response generated by tool if no parameters provided by user tool will provide default paramters
    """),
    ("human", "{input}"),
